...
public class CItyCreation : MonoBehaviour
{
    ...
    */
    List<String> cityInformation = new List<String>()
    {
        ...
        "T1","P","B0","^","v","B2","B0","^","B2","E","E","E","B1","B1","B1","F","^","^","B1","B1","B1","B1","B1","v","v",
        "^","B2","B0","^","v","B2","B0","^","B2","E","E","B0","L1","T2","<","<","X","X","S","<","<","<","<","T3","v",
        "^","B2","B0","^","v","B2","B0","^","B2","E","E","P","T3","v","B3","B3","S","S","B3","B3","B3","B3","B3","v","v",
        "T1","P","B0","^","v","B2","B0","^","B2","E","E","B0","v","v","B2","B0","^","^","B2","E","E","E","B0","v","v",
        "^","F","F","^","v","B2","B0","^","F","B1","B1","F","v","T1","P","B0","^","T1","P","E","E","E","B0","v","v",
        "T1","<","<","T3","v","B2","B0","T1","T2",">","T2",">","T3","v","B2","B0","^","^","F","B1","B1","B1","B1","v","v",
        "^","F","F","^","v","B2","B0","^","^","B2","P","B0","v","v","B2","B0","^","T1","<","<","<","<","<","T3","v",
        "^","F","F","^","T1","P","F","^","^","B2","E","B0","v","T1","P","B0","^","L0","<","T2","<","<","<","T3","v",
        "T1",">",">","X","S",">",">","T0","T1","B2","E","B0","v","T1","T3","F","^","F","B3","P","B3","B3","B0","v","v",
        "T1","T2","T2","S",">","T2","T2",">","T1","B2","P","B0","S","S","^","F","^","F","B1","B1","B1","B1","B0","S","S",
        "^","^","^","R","R","S","S",">",">",">",">","S",">",">","T0",">",">",">",">",">",">",">",">","T3","v",
        "^","^","^","R","R","v","v","S","<","<","<","<","<","<","<","<","<","<","T2","<","<","<","<","T3","v",
        "T1","T0","T0","T2","T2","X","X","S","<","<","<","<","L2","F","B3","B3","B3","B3","P","B3","B3","B3","F","v","v",
        "^","F","F","S","S","v","v","F","B3","B3","B3","F","^","F","B1","B1","P","B1","B1","B1","B1","B1","F","v","v",
        "^","B2","B0","^","^","v","v","B2","E","E","E","P","X","<","<","<","T0","<","<","T2","<","<","<","T3","v",
        "^","B2","B0","^","^","v","v","B2","E","E","E","B0","^","F","B3","B3","P","B3","B3","P","B3","B3","F","v","v",
        "^","B2","B0","^","^","v","T1","P","E","E","E","B0","^","B2","E","E","E","E","E","E","E","E","B0","v","v",
        "^","F","F","^","^","v","v","B2","E","E","E","B0","^","B2","E","E","E","E","E","E","E","E","B0","v","v",
        "^","B2","B0","^","^","v","v","F","B1","B1","B1","F","^","F","B1","B1","B1","B1","B1","B1","P","B1","F","v","v",
        "^","B2","B0","^","T1","T0","T0",">",">",">",">",">","T0",">",">",">",">",">",">",">","T0",">",">","T3","v",
        "^","B2","B0","^","T1",">",">",">",">",">",">",">",">",">",">",">",">",">",">",">",">",">",">","T3","v",
